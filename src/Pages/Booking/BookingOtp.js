    ...
    <div className="flex items-center justify-center">
      <div className="flex flex-col bg-white md:min-w-[800px] min-w-[360px] min-h-screen">
        <div className="flex flex-col items-center px-2.5 w-full text-sm text-neutral-800">
          <button className="flex gap-3 self-start mt-9 font-medium cursor-pointer">
            <svg
              width="26"
              height="26"
              viewBox="0 0 26 26"
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-row justify-center items-center gap-4 md:flex md:flex-row md:items-center md:gap-28">
                  {otp.map((data, index) => {
                    return (
                      <input
                        className="w-12 h-16 border-2 border-black rounded-md text-center"
                        type="text"
                        name="otp"
                        maxLength="1"
                        key={index}
          ...
          <button
            ...
            className="flex flex-col justify-center items-center px-16 py-3.5 mt-14 max-w-full font-medium whitespace-nowrap rounded-xl bg-zinc-300 w-[184px]"
          >
            <svg
              width="30"
              height="17"
