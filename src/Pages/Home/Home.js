...
const Home = () => {
  return (
    <div className="bg-gray-300 flex flex-col items-center min-h-screen py-4">
      <div className="min-w-[360px] flex flex-col items-center  bg-white gap-4 rounded-xl">
        <div className="">
        ...
        <div className="flex gap-5 justify-between w-full text-sm max-w-screen text-neutral-800 py-6">
          <div className="w-full flex flex-col">
            ...
            <div className="px-10">
              <div className="flex flex-col sm:flex-col sm:justify-between px-2  md:justify-center md:flex-col lg:flex-row lg:justify-between   mt-3.5 w-full  rounded-lg shadow-xl  lg:bg-transparent  text-neutral-800 ">
                <div className="">
