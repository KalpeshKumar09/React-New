...
const Profile = () => {
  return (
    <section className="bg-gray-100 min-h-screen flex overflow-hidden py-2 px-2 flex-col">
      <div className="shadow-xl rounded-lg  bg-white">
        <div className="flex p-2 flex-col items-start ">
          <div className="flex flex-col justify-center gap-0">
            ...
            <h2 className="text-[22px] font-normal">Lokesh Ahir</h2>
            <h4 className="text-[16px] font-normal">4.5</h4>
          </div>
          <div className="flex flex-col p-2 border-b-2 border-gray-300 w-full">
            <h2 className="text-[22px] font-normal">Vet Certificate Number</h2>
            <p>D647897</p>
          </div>
          <div className="flex flex-col p-2 border-b-2 border-gray-300 w-full">
          ...
          <div className="flex flex-col p-2 border-b-2 border-gray-300 w-full">
            <h2 className="text-[22px] font-normal">Mobile</h2>
            <p>1233456789</p>
          </div>
          <div className="flex flex-col p-2 border-b-2 border-gray-300 w-full">
            <h2 className="text-[22px] font-normal">Address</h2>
            <p>123 main street anytown</p>
          </div>
          <div className="flex flex-col gap-2">
            <h2 className="text-[22px] font-normal">Certification Documents</h2>
            <img
              src=""
              alt="Vet Licences"
      ...
      <div className="shadow-2xl rounded-lg  bg-white">
        <div className="flex max-w-3xl p-1">
          <div className="flex flex-col shadow-2xl rounded-lg  bg-white">
            <p>
              Provided exceptional care and attention to our furry family member
            </p>
          </div>
        </div>
      </div>
