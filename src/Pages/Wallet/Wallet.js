      ...
      <div className="flex flex-col bg-white  ">
        <div className="flex flex-col px-8 w-full text-neutral-800 md:min-w-[800px] min-w-[360px]">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-2.5 items-start px-2.5 py-2 mt-3 text-sm bg-white rounded-md shadow-sm md:flex md:justify-between">
              <svg
                width="26"
                height="26"
                viewBox="0 0 26 26"
              ...
              <div className="flex flex-col mt-2">
                <h4 className="font-medium">March 15, 2024</h4>
                <p className="mt-2.5">Grooming service for Max.</p>
              </div>
          ...
          <div className="mt-7 text-sm font-medium">Payout History</div>
          <div className="flex flex-col py-2 pr-5 pl-2.5 mt-1 w-full text-sm bg-white rounded-md shadow-sm">
            <div className="flex gap-5 justify-between w-full font-medium">
              <div className="flex gap-3.5">
                ...
                <h4 className="flex-auto my-auto">March 15, 2024</h4>
              </div>
              <h4 className="my-auto">INR 149</h4>
            </div>
            <p className="self-start mt-1 ml-10">Pending</p>
          </div>
