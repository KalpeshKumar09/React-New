...
const TransactionHistory = () => {
  ...
  return (
    <div className="flex flex-col px-8 w-full text-neutral-800 md:min-w-[800px] min-w-[360px]">
      <div className="flex flex-col">
        <h2 className="mt-7 text-sm font-medium">Transaction History</h2>

        {transactions.map((transaction) => (
          <div
            key={transaction.id}
            className="flex gap-2.5 items-center justify-between px-2.5 py-2 mt-3 text-sm bg-white rounded-md shadow-xl"
          >
            <svg
              width="26"
              height="26"
